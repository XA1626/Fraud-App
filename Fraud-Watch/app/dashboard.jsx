      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        {filteredFeatures.includes("URL Checker") && (
          <TouchableOpacity
            ...
            onPress={() => onNavigate("UrlChecker")}
          >
            <Image
              source={require("../assets/url-checker.png")}
        ...
        {filteredFeatures.includes("Cybersecurity News") && (
          <TouchableOpacity
            style={styles.featureButton}
            onPress={() => onNavigate("Newsfeed")}
          >
            <Image
              source={require("../assets/cyber-news.png")}
              style={styles.featureImage}
            />
        ...
        {filteredFeatures.includes("Gmail Integration") && (
          <TouchableOpacity
            style={styles.featureButton}
            onPress={() => onNavigate("GmailIntegration")}
          >
            <Image
        ...
        {filteredFeatures.includes("Fake User Generator") && (
          <TouchableOpacity
            style={styles.featureButton}
            onPress={() => onNavigate("FakeUserGenerator")}
          >
            <Image
              source={require("../assets/fakeusergen.png")}
              style={styles.featureImage}
            />
        ...
        {filteredFeatures.includes("Blacklist") && (
          <TouchableOpacity
            style={styles.featureButton}
            onPress={() => onNavigate("Blacklist")}
          >
            <Image
              source={require("../assets/blacklistbanner.png")}
              style={styles.featureImage}
            />
